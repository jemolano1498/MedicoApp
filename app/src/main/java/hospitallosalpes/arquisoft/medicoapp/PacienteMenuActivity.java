...
public class PacienteMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doctorButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getBaseContext(), VerMedicosActivity.class);
                intent.putExtra("ip", ip);
                startActivity(intent);
            }
        });

        medicionesButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getBaseContext(), VerMedicionesActivity.class);
                intent.putExtra("pacienteActual", pacienteActual);
                intent.putExtra("ip", ip);
                startActivity(intent);
            }
